...
namespace RijamsMod.Items.Weapons
{
	public class ViciousWhip : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.useTime = 36;
			item.shootSpeed = 10f; //range
			item.knockBack = 2f;
			item.width = 44;
			item.height = 36;
			item.UseSound = SoundID.Item77;
			item.shoot = ModContent.ProjectileType<ViciousWhipProj>();
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			if (projectile.modProjectile is ViciousWhipProj modItem)
			{
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<Materials.CrawlerChelicera>(), 4);
