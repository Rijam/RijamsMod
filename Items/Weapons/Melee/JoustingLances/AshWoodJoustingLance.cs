...
{
	public class AshWoodJoustingLance : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.DefaultToSpear(ModContent.ProjectileType<Projectiles.Melee.JoustingLances.AshWoodJoustingLanceProj>(), 0.692857f, 24);
			...
			Item.SetWeaponValues(16, 7.6f, 0); // A special method that sets the damage, knockback, and bonus critical strike chance.

			Item.SetShopValues(ItemRarityColor.White0, Item.sellPrice(0, 0, 0, 35)); // A special method that sets the rarity and value.
