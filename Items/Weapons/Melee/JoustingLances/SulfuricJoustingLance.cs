...
{
	public class SulfuricJoustingLance : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.DefaultToSpear(ModContent.ProjectileType<Projectiles.Melee.JoustingLances.SulfuricJoustingLanceProj>(), 0.93f, 24);
			Item.width = 46;
			Item.height = 46;
			...
			Item.SetShopValues(ItemRarityColor.Green2, Item.sellPrice(0, 1, 20)); // A special method that sets the rarity and value.
		...
		public override void AddRecipes()
		{
			CreateRecipe()
				...
				.AddIngredient(ModContent.ItemType<Sulfur>(), 5)
				.AddIngredient(ModContent.ItemType<InfernicFabric>(), 10)
