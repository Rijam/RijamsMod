...
namespace RijamsMod.Items.Weapons.Melee.JoustingLances
{
	...
	public class WoodenJoustingLance : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.DefaultToSpear(ModContent.ProjectileType<Projectiles.Melee.JoustingLances.WoodenJoustingLanceProj > (), 0.575f, 24);
			...
			Item.SetShopValues(ItemRarityColor.White0, Item.sellPrice(0, 0, 0, 20)); // A special method that sets the rarity and value.
