...
{
	public class PalmWoodJoustingLance : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.DefaultToSpear(ModContent.ProjectileType<Projectiles.Melee.JoustingLances.PalmWoodJoustingLanceProj>(), 0.614285f, 24);
			...
			Item.SetWeaponValues(11, 7.2f, 0); // A special method that sets the damage, knockback, and bonus critical strike chance.
