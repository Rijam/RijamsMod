...
{
	public class EbonwoodJoustingLance : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.DefaultToSpear(ModContent.ProjectileType<Projectiles.Melee.JoustingLances.EbonwoodJoustingLanceProj>(), 0.653571f, 24);
			...
			Item.SetWeaponValues(13, 7.4f, 0); // A special method that sets the damage, knockback, and bonus critical strike chance.
