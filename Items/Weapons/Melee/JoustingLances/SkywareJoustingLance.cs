...
namespace RijamsMod.Items.Weapons.Melee.JoustingLances
{
	...
	public class SkywareJoustingLance : ModItem
	{
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
		{
			...
			Projectile feather = Projectile.NewProjectileDirect(source, position, velocity, ModContent.ProjectileType<SkywareArmorHarpyFeather>(), (int)newDamage, knockback, player.whoAmI);
