...
namespace RijamsMod.Items.Weapons.Melee
{
	...
	public class WoodenJoustingLance : ModItem
	{
		...
		{
			Item.DefaultToSpear(ModContent.ProjectileType<Projectiles.Melee.WoodenJoustingLanceProj>(), 3.5f, 24); // A special method that sets a variety of item parameters that make the item act like a spear weapon.
