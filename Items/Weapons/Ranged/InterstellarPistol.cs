...
namespace RijamsMod.Items.Weapons.Ranged
{
	public class InterstellarPistol : ModItem
	{
		...
		{
			Projectile bullet = ContentSamples.ProjectilesByType[type];
			...
			Projectile laser = Projectile.NewProjectileDirect(source, position + new Vector2(0, -6), velocity * new Vector2(velocityMultiplier, velocityMultiplier), Item.shoot, damage, knockback, player.whoAmI, tileCollide.ToInt());
