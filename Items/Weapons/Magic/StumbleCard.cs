...
namespace RijamsMod.Items.Weapons.Magic
{
	public class StumbleCard : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			ItemOriginDesc.itemList.Add(Item.type, ["[c/474747:Found in Dungeon chests or Golden Lock Boxes]", "[c/474747:Found in Shadow chests or Obsidian Lock Boxes]"]);
		}
		public override void SetDefaults()
		{
			...
			if (!Main.dedServ) //Need to check if a server is running, otherwise it will break multiplayer
			{
				...
				flash.flashTexture = ModContent.Request<Texture2D>(Mod.Name + "/Items/GlowMasks/Clank");
		...
		{
			StumbleCardSingle ??= Mod.Assets.Request<Texture2D>("Items/Weapons/Magic/" + Name + "_Single");
