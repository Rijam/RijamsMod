...
namespace RijamsMod.Projectiles
{
    ...
    public class FestiveWhipProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            //Lighting.AddLight(chainHeadPosition, Color.Lerp(Color.Red, Color.Green, projectile.localAI[1] / 100f).ToVector3() * 0.2f);
            ...
            if (projectile.owner == Main.myPlayer)
            {
                ...
                {   
                    ...
                    //{
                        ...
                        {
                            //Solar Explosion
                            Projectile.NewProjectile(new Vector2(target.position.X, target.position.Y - Main.screenHeight - 100), new Vector2(Main.rand.NextFloat(-2, 2f), Main.rand.NextFloat(5f, 7f)), ProjectileID.OrnamentFriendly, projectile.damage / 2, projectile.knockBack / 2, projectile.owner);
                        }
