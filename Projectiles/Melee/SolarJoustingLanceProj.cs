...
namespace RijamsMod.Projectiles.Melee
{
	...
	public class SolarJoustingLanceProj : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Solar Jousting Lance"); // The English name of the projectile
		...
		public override void AI()
		{
			...
			float tipDist = 98 + extension * extendDist - retraction * retractDist; // If your Jousting Lance is larger or smaller than the standard size, you will need to adjust this number here. 
			...
			if (playerVelocity > minimumDustVelocity && movementInLanceDirection > 0.8f)
			{
				...
				int dustTypeCommon = DustID.SolarFlare;
				int dustTypeRare = DustID.OrangeTorch;
				...
				{
					int newDust = Dust.NewDust(Projectile.Center - new Vector2(offset, offset), offset * 2, offset * 2, dustTypeCommon, Projectile.velocity.X * 0.2f + (Projectile.direction * 3), Projectile.velocity.Y * 0.2f, 100, default, 1.0f);
					Main.dust[newDust].noGravity = true;
					Main.dust[newDust].velocity *= 0.25f;
					newDust = Dust.NewDust(Projectile.Center - new Vector2(offset, offset), offset * 2, offset * 2, dustTypeCommon, 0f, 0f, 150, default, 1.2f);
					Main.dust[newDust].velocity *= 0.25f;
				}
		...
		public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
		{
			...
			float scaleFactor = 160f; // How far back the hit-line will be from the tip of the Jousting Lance. You will need to modify this if you have a bigger or smaller Jousting Lance. Vanilla uses 95f
			float widthMultiplier = 25f; // How thick the hit-line is. Increase or decrease this value if your Jousting Lance is thicker or thinner. Vanilla uses 23f
			...
			// Debug dusts, to easily see where the hit line starts and end
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			/*Rectangle lanceHitboxBounds = new Rectangle(0, 0, 400, 400);
