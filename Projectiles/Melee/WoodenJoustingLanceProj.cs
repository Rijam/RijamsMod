...
namespace RijamsMod.Projectiles.Melee
{
	...
	public class WoodenJoustingLanceProj : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Wooden Jousting Lance"); // The English name of the projectile
		...
		public override void AI()
		{
			...
			float spawnDistance = 12f; // This changes how far out the projectile is spawned. Vanilla uses 28f
		...
		public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
		{
			...
			float scaleFactor = 54f; // How far back the hit-line will be from the tip of the Jousting Lance. You may need to modify this if you have a bigger or smaller Jousting Lance. Vanilla uses 95f
			...
			Rectangle lanceHitboxBounds = new(0, 0, 120, 120);
