...
namespace RijamsMod.Projectiles.Melee
{
	...
	public class WoodenJoustingLanceProj : ModProjectile
	{
		...
		public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
		{
			...
			float scaleFactor = 54f; // How far back the hit-line will be from the tip of the Jousting Lance. You will need to modify this if you have a longer or shorter Jousting Lance. Vanilla uses 95f
