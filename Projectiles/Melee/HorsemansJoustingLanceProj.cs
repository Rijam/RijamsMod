...
namespace RijamsMod.Projectiles.Melee
{
	...
	public class HorsemansJoustingLanceProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			float spawnDistance = 38f; // This changes how far out the projectile is spawned. Vanilla uses 28f
			...
			if (playerVelocity > minimumPlayerVelocity && speedX > minimumSpeedX)
			{
				...
				int dustTypeRare = DustID.Pumpkin;
		...
		public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
		{
			...
			float scaleFactor = 130f; // How far back the hit-line will be from the tip of the Jousting Lance. You may need to modify this if you have a bigger or smaller Jousting Lance. Vanilla uses 95f
