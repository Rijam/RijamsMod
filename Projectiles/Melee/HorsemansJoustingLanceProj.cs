...
namespace RijamsMod.Projectiles.Melee
{
	...
	public class HorsemansJoustingLanceProj : ModProjectile
	{
		...
		public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
		{
			...
			float scaleFactor = 130f; // How far back the hit-line will be from the tip of the Jousting Lance. You need to modify this if you have a bigger or smaller Jousting Lance. Vanilla uses 95f
