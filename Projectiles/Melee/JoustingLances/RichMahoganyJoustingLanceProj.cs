...
{
	public class RichMahoganyJoustingLanceProj : JoustingLanceProjBase
	{
		...
		{
			scaleFactor = 54.75f;
			widthMultiplier = 20.3f;
			lanceHitboxBounds = new(0, 0, 135, 135);
		}

		public override int DollHeldOffset() => 76;
	}
}