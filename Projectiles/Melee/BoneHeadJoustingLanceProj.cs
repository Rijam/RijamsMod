...
namespace RijamsMod.Projectiles.Melee
{
	...
	public class BoneHeadJoustingLanceProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			float spawnDistance = 24f; // This changes how far out the projectile is spawned. Vanilla uses 28f
			...
			if (playerVelocity > minimumPlayerVelocity && speedX > minimumSpeedX)
			{
				...
				int dustTypeCommon = DustID.Bone;
				int dustTypeRare = DustID.BoneTorch;
		...
		public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
		{
			...
			float scaleFactor = 80f; // How far back the hit-line will be from the tip of the Jousting Lance. You may need to modify this if you have a bigger or smaller Jousting Lance. Vanilla uses 95f
			float widthMultiplier = 22f; // How thick the hit-line is. Increase or decrease this value if your Jousting Lance is thicker or thinner. Vanilla uses 23f
			...
			Rectangle lanceHitboxBounds = new(0, 0, 200, 200);
