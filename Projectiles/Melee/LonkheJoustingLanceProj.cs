...
namespace RijamsMod.Projectiles.Melee
{
	...
	public class LonkheJoustingLanceProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			float spawnDistance = 18f; // This changes how far out the projectile is spawned. Vanilla uses 28f
		...
		public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
		{
			...
			float scaleFactor = 64f; // How far back the hit-line will be from the tip of the Jousting Lance. You may need to modify this if you have a bigger or smaller Jousting Lance. Vanilla uses 95f
