...
{
	public class WhirlingFungus : ModProjectile
	{
		...
		public override void OnKill(int timeLeft)
		{
			for (int i = 0; i < 10; i++)
			{
				Dust dust = Dust.NewDustPerfect(Projectile.Center, DustID.MushroomTorch, Main.rand.NextVector2CircularEdge(3f, 3f) * (Main.rand.NextFloat() * 0.5f + 0.5f));
				dust.noGravity = true;
			}
		}
