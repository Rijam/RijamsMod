...
{
	public class TailoThreeCatsProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (num5 > 0.1f && Main.rand.NextFloat() < num5 / 2f)
			{
				...
				int num6 = Dust.NewDust(r4.TopLeft(), r4.Width, r4.Height, DustID.Ash, 0f, 0f, 100, default, 1.0f);
		...
		{
			// target.AddBuff(ModContent.BuffType<Buffs.Debuffs.TailoThreeCatsDebuff>(), 240);
		...
		public override bool PreDraw(Player player, ref Color lightColor)
		{
			...
			RijamsModProjectile.DrawLineForWhips(controlPoints, Color.DarkGray, true);
			...
			for (int i = 0; i < controlPoints.Count - 1; i++)
			{
				...
				Rectangle frame = new(0, 0, 18, 32); // Handle
				Vector2 origin = new(9, 13);
				float scale = 1;
