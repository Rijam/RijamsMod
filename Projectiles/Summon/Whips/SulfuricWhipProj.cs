...
{
    public class SulfuricWhipProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (num5 > 0.1f && Main.rand.NextFloat() < num5 / 2f)
            {
                ...
                int num6 = Dust.NewDust(r4.TopLeft(), r4.Width, r4.Height, ModContent.DustType<Dusts.SulfurDust>(), 0f, 0f, 100, default, 1.5f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                Rectangle frame = new(0, 0, 22, 30); // Handle
