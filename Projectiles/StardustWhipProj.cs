...
namespace RijamsMod.Projectiles
{
    ...
    public class StardustWhipProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(chainHeadPosition, Color.Yellow.ToVector3() * 0.2f);
            ...
            if (projectile.owner == Main.myPlayer)
            {
                ...
                {   
                    ...
                    //{
                        ...
                        {
                            //Solar Explosion
                            Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, ModContent.ProjectileType<StardustExplosion>(), projectile.damage, 0, projectile.owner);
                        }
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            // No addition line of sight check because we want this whip to enemies through walls.
