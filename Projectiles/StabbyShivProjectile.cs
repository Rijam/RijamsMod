...
namespace RijamsMod.Projectiles
{
	...
	public class StabbyShivProjectile : ModProjectile
	{
		...
		public override string Texture => Mod.Name + "/Items/Weapons/StabbyShiv";
	...
	{
		public override string Texture => Mod.Name + "/Items/Weapons/FrostyShiv";
		public override void SetStaticDefaults()
		{
