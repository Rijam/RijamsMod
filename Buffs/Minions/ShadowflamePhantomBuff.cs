...
namespace RijamsMod.Buffs.Minions
{
	public class ShadowflamePhantomBuff : ModBuff
	{
		public override void SetStaticDefaults()
		{
			...
			BuffID.Sets.BuffTextHandlers.Add(Type, new CachedProjectileCounterBuffTextHandler(ModContent.ProjectileType<Projectiles.Summon.Minions.ShadowflamePhantom>()));
		}
